...
COLLECTION_NAME = "proj1-data"          # was "Proj1-data"
...
"""
DATA_INGESTION_COLLECTION_NAME: str = "proj1-data"   # was "Proj1-Data"
...
MODEL_BUCKET_NAME = "my-model-mlopsproj-749474899710-us-east-1-an"
